...
\subsection*{1.д)}
%Тази подточка се проверява съвсем директно и не заслужава особено коментиране.
...
\begin{proof}
    ...
    %Очевидно проблем може да има единствено при равенство на двете събираеми в дясната страна - тоест, когато $|M_\Upsilon| = 0$ (а искаме да докажем, че $M_\Upsilon$ е непразно).
    %Иначе $|M_\Upsilon|$ е строго положително.

    %Най-естествено сега е да допуснем това равенсто и да видим как можем да го счупим:
    %$$|M| = \sum_\gunint |O(\vec g_i)|$$
